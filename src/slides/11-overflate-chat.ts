...
const slide: Slide = {
  ...
  render: () => `
    <section class="slide">
      <div class="eyebrow">Overflate 1 · Chat</div>
      <h2 class="h1">Chat = <span class="gradient-text">orkestrator + spesialister</span></h2>
      <div class="diagram">
        <svg viewBox="0 0 1000 480" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Chat: orkestrator + 4 fagagenter">
          <defs>
          ...
          <g class="ovc-node">
            ...
            <text x="860" y="108" text-anchor="middle" fill="#C8B5FF" font-family="Red Hat Text" font-size="12">eier: Vgs-avdelingen</text>
          </g>
          <g class="ovc-node">
            ...
            <text x="860" y="208" text-anchor="middle" fill="#C8B5FF" font-family="Red Hat Text" font-size="12">eier: Tannhelse</text>
          </g>
          <g class="ovc-node">
            ...
            <text x="860" y="308" text-anchor="middle" fill="#C8B5FF" font-family="Red Hat Text" font-size="12">eier: Samferdsel</text>
          </g>
          <g class="ovc-node">
            ...
            <text x="860" y="408" text-anchor="middle" fill="#C8B5FF" font-family="Red Hat Text" font-size="12">eier: Tilskudd</text>
          </g>
        </svg>
      </div>
      <p class="body" style="color:var(--on-dark-muted);margin-top:var(--s-md);">
        Én chatbot utad. Bak: orkestratoren velger riktig spesialist.<br/>
        Hver agent har <strong style="color:var(--on-dark);">sitt eget eierskap</strong> i fagavdelingen.
      </p>
